...
<body>
    <div class="header">
        <div class="header-top">
            <div class="container">
                <div class="left">
                    <button class="whole-menu-button" title="전체 메뉴"></button>
                ...
                <div class="sub-menu">
                    ...
                    <div class="inner-menu">
                        ...
                        <ul>
                            ...
                            <li><a href=".">- 방사선 치료</a></li>
                            <li><a href=".">- 조형모세포이식</a></li>
                            <li><a href=".">- 면역요법</a></li>
                        </ul>
                        <ul>
                ...
                <div class="sub-menu">
                    ...
                    <div class="inner-menu">
                        <ul>
                            ...
                            <li><a href=".">- - 일상생활</a></li>
                            <li><a href=".">- 기구관리</a></li>
                            <li><a href=".">- - 요루 및 장루</a></li>
                            <li><a href=".">- - 중심정맥관</a></li>
                            <li><a href=".">- - 기관절개공</a></li>
                            <li><a href=".">- - 션트 (Shunt)</a></li>
                            <li><a href=".">- 보완대체요법</a></li>
                            <li><a href=".">- - 보완대체요법의 이해</a></li>
                            <li><a href=".">- - 보완대체요법의 종류</a></li>
                            <li><a href=".">- - 이용시 고려할 점</a></li>
                            <li><a href=".">- 암환자의 복지</a></li>
                            <li><a href=".">- - 개요</a></li>
                            <li><a href=".">- - 병원 내 사회복지사업</a></li>
                            <li><a href=".">- - 후원기관 및 절차</a></li>
                ...
                <div class="sub-menu">
                    ...
                    <div class="inner-menu">
                        <ul>
                            ...
                            <li><a href=".">- 국가암검진사업</a></li>
                            <li><a href=".">- 지역암센터운영사업</a></li>
                            <li><a href=".">- 암환자의료비지원사업</a></li>
                            <li><a href=".">- 재난적의료비지원사업</a></li>
                            <li><a href=".">- 재가암환자관리사업</a></li>
                            <li><a href=".">- 호스피스완화의료사업</a></li>
                            <li><a href=".">- 골수기증사업</a></li>
