        ...
        <div class="left-menu">
            ...
            <ul>
                <li class="active">
                    ...
                    <ul class="inner-menu">
                        <li class="active">
                            <div class="util">일반적인 암예방</div>
                            <ul>
                                <li><a href=".">- 개요</a></li>
                                <li class="active"><a href=".">- 일반적인 암의 원인</a></li>
                                <li><a href=".">- 국민 암예방 수칙</a></li>
                            </ul>
                        </li>
                        <li>
                            <div class="util">금연</div>
                            <ul>
                                <li><a href=".">- 개요</a></li>
                                <li><a href=".">- 일반적인 암의 원인</a></li>
                                <li><a href=".">- 국민 암예방 수칙</a></li>
                            </ul>
                        </li>
                        <li>
                            <div class="util">식이</div>
                            <ul>
                                <li><a href=".">- 개요</a></li>
                                <li><a href=".">- 일반적인 암의 원인</a></li>
                                <li><a href=".">- 국민 암예방 수칙</a></li>
                ...
                <li>
                    <div class="util">
                        <span class="title">검진</span>
                        <div class="arrow"></div>
                    </div>
                </li>
                <li>
                    <div class="util">
                        <span class="title">발암요인</span>
                        <div class="arrow"></div>
                    </div>
                </li>
            </ul>
